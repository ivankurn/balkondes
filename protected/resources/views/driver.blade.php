...
<p>Berikut ini adalah tugas pengantaran yang harus Anda kerjakan hari ini:</p>
<br>
<div class="portlet light bordered" style="margin-top:13px">
	<div class="portlet-title tabbable-line">
		<div class="caption caption-md">
			<i class="icon-globe theme-font hide"></i>
			<span class="caption-subject font-green bold uppercase">Tugas Pengantaran</span>
		</div>
	</div>
	<div class="portlet-body" >
		@if(isset($schedule) && !empty($schedule))
			<table  class="table table-striped table-bordered table-hover dt-responsive sample_1" width="100%">
				...
				<tbody>
					...
					<tr>
						<td> {{ $key+1 }}</td>
						<td> @if($row['status_pengantaran'] == 'Queue') <div style="color: #bcb30c;"><b>Menunggu</b></div>
							@elseif($row['status_pengantaran'] == 'On Process')<div tyle="color: #16bc0c;"><b>Sedang Diantar</b></div>
							@endif
						<br><br>
							@if($row['status_pengantaran'] == 'Queue')
								<a class="btn yellow btn-sm btn-block" data-toggle="modal" href="{{url('pesanan/diantar')}}/{{$row['id_driver_schedule']}}"><i class="fa fa-check"></i> Sedang Diantar </a>
							@endif
							@if($row['status_pengantaran'] == 'On Process')
								<a class="btn green btn-sm btn-block" data-toggle="modal" href="{{url('pesanan/selesai')}}/{{$row['id_driver_schedule']}}"><i class="fa fa-check"></i> Selesai </a>
							@endif
						</td>
		...
		@else
			<p>
				Maaf, Belum ada jadwal pengantaran untuk hari ini
			</p>
		@endif
	</div>
</div>
