$(document).ready(function(){
  ...
  generateChartDataTiga(result, group);
    ...
    function generateChartDataSatu(data, group) {
        ...
        var chart = AmCharts.makeChart("report_omzet_count", {
            "type": "serial",
            "theme": "light",
            "legend": {
	...
	function generateChartDataDua(data, group) {
        ...
        for (var i = 0; i < length; i++) {
            ...
            chartData.push({
                date        : keterangan,
                roll      : data[i]['total_roll'],
                ongkir 		: data[i]['ongkir'],
            });

        }
        var chart = AmCharts.makeChart("report_total_roll_ongkir", {
            "type": "serial",
            "theme": "light",
            "legend": {
                "useGraphSettings": true
	...
	function generateChartDataTiga(data, group) {
        ...
        var chart = AmCharts.makeChart("report_berat_quantity", {
            "type": "serial",
            "theme": "light",
            "legend": {
                "useGraphSettings": true
